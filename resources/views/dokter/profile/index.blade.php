                ...
                <div class="card">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-0">
                            <i class="bi bi-hospital"></i> {{ $dokter->bidang_dokter ?? '-' }}
                        </p>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <p class="text-muted mb-0">{{ $dokter->email ?? '-' }}</p>
                        </div>
                        <div class="mb-3">
                            <strong><i class="bi bi-phone"></i> No. HP</strong>
                            <p class="text-muted mb-0">{{ $dokter->no_hp ?? '-' }}</p>
                        </div>
                        <div class="mb-0">
                            <strong><i class="bi bi-geo-alt"></i> Alamat</strong>
                            <p class="text-muted mb-0">{{ $dokter->alamat ?? '-' }}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <table class="table table-borderless">
                            <tbody>
                                ...
                                <tr>
                                    <td><strong>Bidang Dokter</strong></td>
                                    <td>
