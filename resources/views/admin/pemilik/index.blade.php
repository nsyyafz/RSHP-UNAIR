...
<head>
    ...
    <title>Daftar Pemilik - Admin RSHP</title>
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    ...
                    <p>Kelola data pemilik hewan peliharaan di RSHP Universitas Airlangga</p>
                </div>
                ...
                <table class="table custom-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="id-badge">{{ $item->idpemilik }}</span>
                            </td>
                            <td>
                                <strong style="color: #003366;">{{ $item->user->nama }}</strong>
                            </td>
                            <td>
                                @if($item->no_wa)
                                    <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $item->no_wa) }}" 
                                       target="_blank" 
                                       class="wa-link">
                                        📱 {{ $item->no_wa }}
                                    </a>
