...
<head>
    ...
    <title>Edit Pemilik - Admin RSHP</title>
...
<body>
    <div class="container">
        <div class="page-header">
            <div>
                <h1>✏️ Edit Pemilik</h1>
                <p>Perbarui data pemilik hewan peliharaan</p>
            </div>
        </div>

        <div class="form-card">
            <h5><i class="bi bi-pencil-square"></i> Form Edit Data Pemilik</h5>

            <div class="alert-info-custom">
                <i class="bi bi-info-circle-fill"></i>
                <strong>Informasi:</strong> ID Pemilik tidak dapat diubah untuk menjaga integritas data.
            </div>
            ...
            <form action="{{ route('pemilik.update', $pemilik->idpemilik) }}" method="POST">
                ...
                <div class="mb-4">
                    <label class="form-label">
                        <i class="bi bi-hash"></i> ID Pemilik
                    </label>
                    <div class="id-display">
                        <i class="bi bi-shield-check"></i> {{ $pemilik->idpemilik }}
                    </div>
