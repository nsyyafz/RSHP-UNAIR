...
<head>
    ...
    <title>Edit Hewan Peliharaan - Admin RSHP</title>
...
<body>
    <div class="container">
        <div class="page-header">
            <div>
                <h1>✏️ Edit Data Hewan Peliharaan</h1>
                <p>Perbarui informasi hewan peliharaan</p>
            </div>
        </div>

        <div class="form-card">
            <h5><i class="bi bi-pencil-square"></i> Form Edit Data Hewan</h5>

            <div class="alert-info-custom">
                <i class="bi bi-info-circle-fill"></i>
                <strong>Informasi:</strong> ID Hewan tidak dapat diubah untuk menjaga integritas data.
            </div>
            ...
            <form action="{{ route('pet.update', $pet->idpet) }}" method="POST">
                ...
                <div class="mb-4">
                    <label class="form-label">
                        <i class="bi bi-hash"></i> ID Hewan
                    </label>
                    <div class="id-display">
                        <i class="bi bi-shield-check"></i> {{ $pet->idpet }}
                    </div>
                ...
                <div class="mb-4">
                    ...
                    <textarea 
                        ...
                        required
                    >{{ old('warna_tanda', $pet->warna_tanda) }}</textarea>
                    @error('warna_tanda')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
