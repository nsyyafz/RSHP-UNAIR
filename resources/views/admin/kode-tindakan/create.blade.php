...
<head>
    ...
    <title>Tambah Kode Tindakan Terapi - Admin RSHP</title>
...
<body>
    <div class="container">
        <div class="page-header">
            <div>
                <h1>➕ Tambah Kode Tindakan Terapi Baru</h1>
                <p>Tambahkan kode tindakan terapi baru ke dalam sistem RSHP</p>
            </div>
        </div>

        <div class="form-card">
            <h5><i class="bi bi-clipboard-plus"></i> Form Input Data Kode Tindakan</h5>

            <div class="alert-info-custom">
                <i class="bi bi-info-circle-fill"></i>
                <strong>Informasi:</strong> ID Kode Tindakan akan dibuat secara otomatis oleh sistem.
            </div>
            ...
            <form action="{{ route('kode-tindakan.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    @enderror
                    <small class="form-text">Masukkan kode unik untuk tindakan (akan otomatis uppercase)</small>
                </div>
                ...
                <div class="mb-4">
                    ...
                    @error('deskripsi_tindakan_terapi')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="form-text">Jelaskan tindakan terapi secara detail (minimal 5 karakter)</small>
                </div>
