...
<head>
    ...
    <title>Edit Kategori - Admin RSHP</title>
...
<body>
    <div class="container">
        ...
        <!-- Form Card -->
        <div class="form-card">
            <h5><i class="bi bi-pencil-square"></i> Form Edit Data Kategori</h5>
            ...
            <form action="{{ route('kategori.update', $kategori->idkategori) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <div class="id-display">
                        <i class="bi bi-shield-check"></i> {{ $kategori->idkategori }}
                    </div>
                ...
                <div class="mb-4">
                    ...
                    @enderror
                    <small class="form-text">Perbarui nama kategori sesuai kebutuhan</small>
                </div>
