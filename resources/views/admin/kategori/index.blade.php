...
<head>
    ...
    <title>Manajemen Kategori - Admin RSHP</title>
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    ...
                    <p>Kelola kategori tindakan terapi RSHP Universitas Airlangga</p>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <strong style="color: #003366; font-size: 1.05rem;">
                                    <i class="bi bi-folder2"></i> {{ $kategori->nama_kategori }}
                                </strong>
                            </td>
                            <td>
                                <div class="action-buttons justify-content-center">
                                    <a href="{{ route('kategori.edit', $kategori->idkategori) }}" class="btn-action btn-edit">
                                        <i class="bi bi-pencil-square"></i> Edit
                                    </a>
                                    <form action="{{ route('kategori.destroy', $kategori->idkategori) }}" method="POST" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus data ini?');">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <tr>
                            <td colspan="4" class="empty-state">
                                ...
                                <p>Belum ada data kategori. Klik tombol "Tambah Kategori" untuk menambahkan data.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
