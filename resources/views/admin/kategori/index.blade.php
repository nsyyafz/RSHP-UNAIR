            ...
            <div class="col-12">
                <div class="card">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <span class="badge text-bg-primary">{{ $item->idkategori }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                ...
                                                <form action="{{ route('kategori.destroy', $item->idkategori) }}" 
                                                      ...
                                                      onsubmit="return confirm('Yakin ingin menghapus {{ $item->nama_kategori }}?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center py-5">
                                            <div class="text-muted">
                                                ...
                                                <p class="mt-3">Tidak ada data kategori</p>
                                                <a href="{{ route('kategori.create') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="card-footer clearfix">
                        <div class="float-end">
                            <span class="text-muted">Total: <strong>{{ count($kategoris) }}</strong> data</span>
                        </div>
                    </div>
                    @endif
                </div>
