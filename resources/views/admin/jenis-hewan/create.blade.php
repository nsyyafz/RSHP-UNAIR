...
<head>
    ...
    <title>Tambah Jenis Hewan - Admin RSHP</title>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Tambahkan data jenis hewan ke dalam sistem RSHP</p>
            </div>
        </div>
        ...
        <div class="form-card">
            ...
            <form action="{{ route('jenis-hewan.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    @enderror
                    <small class="form-text">Masukkan nama jenis hewan dengan jelas</small>
                </div>
