        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('temu-dokter.index') }}">Temu Dokter</a></li>
        ...
        <div class="row">
            <div class="col-md-10 offset-md-1">
                <div class="card">
                    ...
                    <form action="{{ route('temu-dokter.update', $temuDokter->idreservasi_dokter) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            @if($errors->any())
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('temu-dokter.index', $temuDokter->idreservasi_dokter) }}" class="btn btn-secondary"><i class="bi bi-x-circle"></i> Batal</a>
                        </div>
                    </form>
                </div>
            </div>
