<nav class="navbar navbar-expand-lg navbar-dark shadow-sm" style="background: linear-gradient(135deg, #003366 0%, #005599 100%);">
    <div class="container-fluid px-4">
        <a class="navbar-brand fw-bold d-flex align-items-center" href="{{ route('admin.dashboard') }}">
            ...
            <div>
                <div style="font-size: 1.1rem;">Dashboard Admin</div>
            ...
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('jenis-hewan') }}">
                            <i class="bi bi-list-ul"></i> Jenis Hewan
                        </a></li>
                        <li><a class="dropdown-item" href="{{ route('pemilik') }}">
