...
<head>
    ...
    <title>Tambah User - Admin RSHP</title>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Tambahkan data pengguna baru ke dalam sistem RSHP</p>
            </div>
        </div>

        <!-- Form Card -->
        <div class="form-card">
            <h5><i class="bi bi-person-plus-fill"></i> Form Input Data User</h5>

            <!-- Info Alert -->
            <div class="alert-info-custom">
                <i class="bi bi-info-circle-fill"></i>
                <strong>Informasi:</strong> ID User akan dibuat secara otomatis oleh sistem. Pastikan semua data diisi dengan benar.
            </div>
            ...
            <form action="{{ route('user.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    @enderror
                    <small class="form-text">Masukkan nama lengkap pengguna</small>
                </div>
