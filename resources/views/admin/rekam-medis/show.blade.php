            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('rekam-medis.edit', $rekamMedis->idrekam_medis) }}" class="btn btn-warning btn-sm">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('rekam-medis.detail.destroy', ['id' => $rekamMedis->idrekam_medis, 'iddetail' => $detail->iddetail_rekam_medis]) }}" 
                                                  method="POST" 
                        ...
                        <div class="border-top pt-4">
                            ...
                            <form action="{{ route('rekam-medis.detail.store', $rekamMedis->idrekam_medis) }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="mb-3">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('rekam-medis.edit', $rekamMedis->idrekam_medis) }}" class="btn btn-warning">
