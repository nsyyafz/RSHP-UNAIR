        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <form action="{{ route('rekam-medis.update', $rekamMedis->idrekam_medis) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="card-body">
                            <div class="alert alert-info">
                                <i class="bi bi-info-circle me-2"></i>
                                <strong>Informasi:</strong> Anda hanya dapat mengubah data rekam medis (anamnesa, diagnosa, temuan klinis). Untuk mengelola detail tindakan, gunakan halaman detail rekam medis.
                            </div>
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-between">
                                <a href="{{ route('rekam-medis.show', $rekamMedis->idrekam_medis) }}" class="btn btn-secondary">
