...
<head>
    ...
    <title>Tambah Ras Hewan - Admin RSHP</title>
    ...
    <div class="container">
        ...
        <div class="page-header">
            <div>
                ...
                <p>Tambahkan data ras hewan ke dalam sistem RSHP</p>
            </div>
        </div>

        <!-- Form Card -->
        <div class="form-card">
            <h5><i class="bi bi-clipboard-plus"></i> Form Input Data</h5>

            <!-- Info Alert -->
            <div class="alert-info-custom">
                <i class="bi bi-info-circle-fill"></i>
                <strong>Informasi:</strong> ID Ras Hewan akan dibuat secara otomatis oleh sistem.
            </div>
            ...
            <form action="{{ route('ras-hewan.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    >
                        ...
                        @foreach($jenisHewans as $jenisHewan)
                            <option value="{{ $jenisHewan->idjenis_hewan }}" {{ old('idjenis_hewan') == $jenisHewan->idjenis_hewan ? 'selected' : '' }}>
                    ...
                    @enderror
                    <small class="form-text">Pilih jenis hewan untuk ras ini</small>
                </div>
                ...
                <div class="mb-4">
                    ...
                    @error('nama_ras')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="form-text">Masukkan nama ras hewan dengan jelas</small>
                </div>
