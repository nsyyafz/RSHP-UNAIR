    ...
    <div class="container">
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    <h1>🔐 Daftar Role</h1>
                    <p>Kelola peran dan hak akses pengguna sistem RSHP</p>
                </div>
                ...
                <table class="table custom-table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 200px;">ID Role</th>
                            <th>Nama Role</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="id-badge">{{ $role->idrole }}</span>
                            </td>
                            <td>
                                <strong style="color: #003366;">{{ $role->nama_role }}</strong>
                            </td>
                        </tr>
                        @empty
                        <tr>
