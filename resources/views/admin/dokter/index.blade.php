            ...
            <div class="col-12">
                <div class="card">
                            ...
                            <table class="table table-striped table-hover mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <strong><i class="bi bi-person-badge-fill text-primary"></i> {{ $dokter->nama ?? '-' }}</strong>
                                        </td>
                                        <td>
                                            <span class="badge text-bg-info">
                                                <i class="bi bi-stethoscope"></i> {{ $dokter->bidang_dokter }}
                                            </span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="badge text-bg-success">
                                                <i class="bi bi-telephone-fill"></i> {{ $dokter->no_hp }}
                                            </span>
                                        </td>
                                        <td>
                                            <i class="bi bi-geo-alt text-danger"></i> {{ $dokter->alamat }}
                                        </td>
                                        <td>
                                            <small class="text-muted">
                                                <i class="bi bi-envelope"></i> {{ $dokter->email ?? '-' }}
                                            </small>
                                        </td>
                                        <td class="text-center">
                                            <div class="btn-group" role="group">
                                                ...
                                                <form action="{{ route('dokter.destroy', $dokter->id_dokter) }}" 
                                                      ...
                                                      onsubmit="return confirm('Yakin ingin menghapus data dokter {{ $dokter->nama ?? 'ini' }}?');">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" 
                                    ...
                                    <tr>
                                        <td colspan="8" class="text-center py-5">
                                            <div class="text-muted">
                                                ...
                                                <p class="mt-3">Tidak ada data dokter</p>
                                                <a href="{{ route('dokter.create') }}" class="btn btn-primary btn-sm">
                    ...
                    <div class="card-footer clearfix">
                        <div class="float-end">
                            <span class="text-muted">Total: <strong>{{ $dokters->count() }}</strong> data</span>
                        </div>
                    </div>
                    @endif
                </div>
