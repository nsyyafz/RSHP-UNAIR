...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="mb-0">Dashboard Admin RSHP</h3>
            </div>
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        ...
                        <span class="info-box-number">{{ $jumlahTemuDokter }}</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-4">
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Ringkasan Data Transaksional</h3>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                    ...
                    <div class="card-body">
                        ...
                        <div class="progress-group mb-3">
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="fw-bold">{{ $jumlahTemuDokter }}</span>
                            </div>
                            <div class="progress">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-2 col-6 mb-3">
                                <a href="{{ route('pet.index') }}" class="btn btn-app w-100">
                                    <i class="bi bi-heart-fill"></i> Pet
                                </a>
                            </div>
                            <div class="col-md-2 col-6 mb-3">
                                <a href="{{ route('pemilik.index') }}" class="btn btn-app w-100">
                                    <i class="bi bi-person-fill"></i> Pemilik
                                </a>
                            </div>
                            <div class="col-md-2 col-6 mb-3">
                                <a href="{{ route('rekam-medis.index') }}" class="btn btn-app w-100">
                                    <i class="bi bi-clipboard2-pulse-fill"></i> Rekam Medis
                                </a>
                            </div>
                            <div class="col-md-2 col-6 mb-3">
                                <a href="{{ route('temu-dokter.index') }}" class="btn btn-app w-100">
                                    <i class="bi bi-calendar-check-fill"></i> Temu Dokter
                                </a>
                            </div>
                            <div class="col-md-2 col-6 mb-3">
                                <a href="{{ route('user.index') }}" class="btn btn-app w-100">
                                    <i class="bi bi-people-fill"></i> User
                                </a>
                            </div>
                            <div class="col-md-2 col-6 mb-3">
                                <a href="{{ route('jenis-hewan.index') }}" class="btn btn-app w-100">
