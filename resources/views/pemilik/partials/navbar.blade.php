<nav class="navbar navbar-expand-lg navbar-dark shadow-sm" style="background: linear-gradient(135deg, #e67e22 0%, #f39c12 100%);">
    <div class="container-fluid px-4">
        <a class="navbar-brand fw-bold d-flex align-items-center" href="{{ route('pemilik.dashboard') }}">
            ...
            <div>
                <div style="font-size: 1.1rem;">Dashboard Pemilik</div>
            ...
            <ul class="navbar-nav ms-auto align-items-lg-center">
                ...
                <li class="nav-item">
                    <span class="nav-link text-white">
                        <i class="bi bi-person-circle"></i> {{ auth()->user()->name ?? session('user_name') }}
                    </span>
                </li>
                <li class="nav-item">
...
<style>
    ...
    .btn-outline-light:hover {
        ...
        box-shadow: 0 4px 10px rgba(255, 190, 118, 0.3);
    }
